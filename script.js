document.addEventListener(`DOMContentLoaded`, function() {
    ...
    const _createCardTask = document.getElementById(`create-task-card`)
    ...
    function createCards () {
        ...
        tasks.forEach(task => {
            ...
            <div class="card text-bg-primary mb-3" id="draggableDiv" draggable="true" style="max-width: 22rem;">
            ...
            _createCardTask.appendChild(createTaskCard)
        });
